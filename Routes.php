    ...
    case 'GET':
        switch ($_SERVER['REQUEST_URI']) {
            ...
            case '/LegendsOfLegends/MatchHistories':
                ...
                break;
            case "/LeagueOfLegends/Profile/{$_SESSION["Search"]["LeagueOfLegends"]["Summoner"]["gameName"]}":
                $Router = new Router("GET", "/LeagueOfLegends/Profile/{$_SESSION["Search"]["LeagueOfLegends"]["Summoner"]["gameName"]}", "/Views/LeagueOfLegendsProfile.php");
                break;
